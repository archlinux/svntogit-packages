...
build() {
   ...
   make || return 1
   make prefix=$startdir/pkg/usr bindir=$startdir/pkg/usr/bin mandir=$startdir/pkg/usr/share/man datadir=$startdir/pkg/usr/share/eboard sysconfdir=$startdir/pkg/etc localstatedir=$startdir/pkg/var install
}
